...
2. Clone magento2-docker repository and Build the docker Images:
        ...
        * Goto "magento2-4-8-docker" folder
...
```
           ...
           * cd /var/www/magento248
           
           * If its an existent project, clone project repository to the 'magento248', then update env.php and go to #8
           
           * Install Magento Instance magento248 ( https://devdocs.magento.com/guides/v2.4/install-gde/composer.html )
          		...
          		2. Install M2 via CLI(/var/www/magento248):
                       
                        bin/magento setup:install \
                        --base-url=http://magento248.loc/ \
                        --db-host=mariadb \
                        --db-name=magento248 \
                        --db-user=mage248_user \
                        --db-password=mage248_pass \
                            ...
                            'default' => [
                                'catalog' => [
                                    'search' => [
                                        ...
                                        'opensearch_index_prefix' => 'magento248',
                                    ]
                                ]
                            ]
                        ],
...
6. Configure your hosts file: 127.0.0.1 magento248.loc
    1. In windows:-  c:\Windows\System32\Drivers\etc\hosts.
    2. Mac/Ubuntu:-  /etc/hosts

7. Open http://magento248.loc/

8. Open http://magento248.loc/admin/
...
10.2) Modify nginx config file in docker(docker/nginx/default.conf): <br />
         ...
         map $http_host $MAGE_RUN_CODE {
            magento248-second.loc second_website_code;
            magento248.loc base;
         }
         upstream fastcgi_backend {
          ...
          server {
              listen 80;
              server_name magento248.loc magento248-second.loc;
              set $MAGE_ROOT /var/www/magento248;
              ...
              include /var/www/magento248/nginx.conf.sample;
              error_log /var/log/nginx/error.log;
              access_log /var/log/nginx/access.log;
          }


10.3). Configure your hosts file: 127.0.0.1 magento248.loc magento248-second.loc <br />
1. In windows:-  c:\Windows\System32\Drivers\etc\hosts. <br />
2. Mac/Ubuntu:-  /etc/hosts     <br />

10.4). Modifty nginx.conf.sample(magento248/nginx.conf.sample)<br />
